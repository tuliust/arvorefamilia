...
const orangePaletteVariables: Record<TreeColorPaletteCssVariable, string> = {
  ...
  '--tree-palette-card-tataravos': 'linear-gradient(135deg, #CBC3E0, #B7AED6)',
  '--tree-palette-card-bisavos': 'linear-gradient(135deg, #E0AFD1, #D49BC5)',
  '--tree-palette-card-avos': 'linear-gradient(135deg, #F0B8B2, #E8A29B)',
  '--tree-palette-card-tios': 'linear-gradient(135deg, #F1C2A5, #EAB08F)',
  '--tree-palette-card-primos': 'linear-gradient(135deg, #EDC997, #E7B985)',
  '--tree-palette-card-pais': 'linear-gradient(135deg, #EAD08F, #E4C37A)',
  '--tree-palette-card-central': 'linear-gradient(135deg, #F5F1E5, #DCE6E4)',
  '--tree-palette-card-irmaos': 'linear-gradient(135deg, #B9D783, #A9CB72)',
  '--tree-palette-card-sobrinhos': 'linear-gradient(135deg, #C7DBD1, #B8CEC2)',
  '--tree-palette-card-netos': 'linear-gradient(135deg, #CBE3E6, #BDD8DC)',
  '--tree-palette-card-pets': 'linear-gradient(135deg, #F7D3BD, #F4C7AB)',
  '--tree-palette-group-bg': '#FFF7ED',
