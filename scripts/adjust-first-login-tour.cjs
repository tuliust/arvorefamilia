...
const tutorialPath = path.join(root, 'src/app/pages/home/FirstLoginTutorial.tsx');
...
if (!fs.existsSync(tutorialPath)) {
  fail('Arquivo não encontrado: src/app/pages/home/FirstLoginTutorial.tsx');
}

const tutorialComponent = String.raw`import React, { useEffect, useMemo, useState } from 'react';
import {
  Bell,
  CalendarDays,
  CheckCircle2,
...
fs.writeFileSync(tutorialPath, tutorialComponent, 'utf8');

console.log('\nTour guiado ajustado com sucesso.');
console.log('Alteração aplicada em: src/app/pages/home/FirstLoginTutorial.tsx');
console.log('\nAgora rode:');
