...
export function AdminDashboard() {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      description: 'Upload de JSON/CSV',
      icon: Upload,
      onClick: () => navigate('/admin/importacao'),
      color: 'bg-amber-500'
    },
    {
      title: 'Migrar para Banco',
      description: 'Carregar seed no Supabase',
      icon: Database,
      onClick: () => navigate('/admin/migrar-dados'),
      color: 'bg-red-500'
    },
    {
      title: 'Diagnóstico',
      ...
      icon: BarChart3,
      onClick: () => navigate('/admin/diagnostico'),
      color: 'bg-cyan-500'
    },
  ];
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold text-gray-900">{stats.totalRelacionamentos}</div>
              <p className="text-xs text-gray-500 mt-1">
