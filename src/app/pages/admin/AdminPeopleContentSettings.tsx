...
export function AdminPeopleContentSettings() {
  ...
  useEffect(() => {
    ...
    async function loadDetails() {
      try {
        ...
        setInsightDraft(createDraftFromInsights(generatedInsights, selectedPessoa?.data_nascimento));
      } catch (error) {
  ...
  const handleGenerateInsights = async (force: boolean) => {
    ...
    try {
      ...
      setInsightDraft(createDraftFromInsights(refreshed, selectedPessoa.data_nascimento));
