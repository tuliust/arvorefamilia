...
| `MIGRATIONS_SUPABASE.md` | Fluxo seguro de migrations, `supabase migration list`, `supabase db push`, schema cache, RLS, RPCs, SQL legado e validação pós-migration. | Canônico para banco. |
...
| `OAUTH_GOOGLE.md` | Operação específica de Google OAuth/Google Agenda, consent screen, test users, domínio, redirects e troubleshooting. | Complementar/canônico para OAuth Google. |
