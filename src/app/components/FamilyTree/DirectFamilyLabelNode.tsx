...
export const DirectFamilyLabelNode = React.memo(({ data }: NodeProps<DirectFamilyLabelNodeData>) => {
  ...
  return (
    <div
      className="pointer-events-none select-none rounded-md border border-slate-500/40 bg-white px-3 py-1 text-center text-xs font-bold uppercase tracking-normal text-slate-800"
      aria-label={data.label}
